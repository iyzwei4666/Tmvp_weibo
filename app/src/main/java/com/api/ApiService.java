...
//    statuses/go	uid id 根据ID跳转到单条微博页
    ...
    Flowable<TimelineRet> statuses_home_timeline(@Query("access_token") String access_token );
    ...
    Flowable<TimelineRet> statuses_show(@Query("access_token") String access_token, @Query("id") String id);

    @GET("statuses/count.json")
    Flowable<TimelineRet> statuses_count(@Query("access_token") String access_token, @Query("ids") String ids);

    @GET("statuses/go.json")
    Flowable<TimelineRet> statuses_go(@Query("uid") String uid, @Query("id") String id);
